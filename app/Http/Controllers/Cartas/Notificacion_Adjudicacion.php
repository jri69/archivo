...
class Notificacion_Adjudicacion extends Fpdf
{
    ...
    public function informe($data)
    {
        ...
        // CONTENIDO
        $contenido = [
            'first' => 'En relación del proceso: Requerido con CITE <ESCUELA DE INGENIERIA OF.COORD. ACA. N.º 1269/2022> de la Escuela de Ingeniería, Contratación Menor de un Consultor Individual por Producto para el <MÓDULO> denominado: "' . $modulo->nombre . '", en relación' . $name_programa . '; a Ejecutarse con Recursos Propios, ya que cuenta con Registro de ejecución de Gastos Preventivo Nº 1332.',
