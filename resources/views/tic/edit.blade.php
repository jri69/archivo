@extends('layouts.app', ['activePage' => 'tic', 'titlePage' => 'TIC'])
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row" style="margin-left: 10%">
                <div class="col-md-11">
                    <form action="{{ route('tic.update', $tic->id) }}" method="post" class="form-horizontal"
                        ...
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="number" class="form-control" min="0" name="cantidad"
                                            placeholder="Cantidad" value="{{ $tic->cantidad }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea name="observaciones" id="observaciones" cols="30" rows="10" class="form-control"
                                            placeholder="Observaciones"> {{ $tic->observaciones }}</textarea>
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                ...
                                <a href="{{ route('tic.index') }}" class="btn btn-primary"><b>Cancelar</b></a>
                            </div>
                        </div>
                    </form>
                </div>
