...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{ route('pago.update',$pago->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">                            
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <textarea class="textarea resize-ta" name="observaciones" id="" cols="60" rows="3"  
