    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row" style="margin-left: 10%">
                <div class="col-md-11">
                    <form action="{{ route('pago.store', $id) }}" method="post" class="form-horizontal"
                        ...
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="number" class="form-control" name="comprobante"
                                            value="{{ old('comprobante') }}" autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="file" class="form-control" name="compro_file"
                                            placeholder="Seleccione un documento..." accept=".docx, .pdf, .doc, .png, .jpg"
                                            value="{{ old('compro_file') }}" autofocus>
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                ...
                                <a href="{{ route('pago_estudiante.show_programa', $id) }}"
