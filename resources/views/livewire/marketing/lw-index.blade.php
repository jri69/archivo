                                            ...
                                            <td class="td-actions">
                                                @if ($prospecto->telefono)
                                                    <a aria-label="Chat on WhatsApp"
                                                        href={{ 'https://wa.me/591' . $prospecto->telefono }}
                                                        class="btn" target="_blank">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 41"
                                                            width="18px" height="13px" fill-rule="evenodd"
                                                            clip-rule="evenodd">
                                                            <path fill="#fff"
                                                ...
                                                @endif
                                                <a href="{{ route('marketing.edit', $prospecto->id) }}"
                                                    class="btn btn-primary">
                                                    <span class="material-icons">edit</span>
                                                </a>
                                                <form action="{{ route('marketing.delete', $prospecto->id) }}"
