...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-10">
                <form action="{{route('administrativo.update',$administrativo->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-sm-8">
                              <div class="input-group">
                                ...
                                min="1"
                                       ...
                                       class="form-control"
                                       name="ci"
                                       value="{{ old('ci',$administrativo->ci) }}" autofocus
                                    >
                                    @if ($errors->has('ci'))
                        ...
                        <br>
                        <div class="row">
                            <label for="nombre" class="col-sm-2 col-form-label"> <b> Tipo de Contrato:</b> </label>
                            <div class="col-sm-8">
                        ...
                        <br>
                        <div class="row">
                            <label for="nombre" class="col-sm-2 col-form-label"> <b> Fecha de Ingreso:</b> </label>
                            <div class="col-sm-8">
