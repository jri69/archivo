@extends('layouts.app', ['activePage' => 'factura', 'titlePage' => 'Editar Factura'])
...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="margin-left: 10%">
            <div class="col-md-11">
                <form action="{{route('factura.update',$factura->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">                        
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                id="_numero"
                                name="numero"
                                value="{{ old('numero',$factura->numero) }}" autofocus>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                id="_fecha"
                                name="fecha"
                                value="{{ old('fecha',$factura->fecha) }}" autofocus>
                                @if ($errors->has('fecha'))
                                    <span class="error text-danger" for="input-nombre">
                                        {{ $errors->first('fecha') }}
                                    </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                id="_monto"
                                name="monto"
                                value="{{ old('monto',$factura->monto) }}" autofocus>
                                @if ($errors->has('monto'))
                                    <span class="error text-danger" for="input-nombre">
                                        {{ $errors->first('monto') }}
                                    </span>
