    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row" style="margin-left: 10%">
                <div class="col-md-11">
                    <form action="{{ route('estudiante.titulacionUpdate', $titulacion->id) }}" method="post"
                        ...
                        <div class="card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="lineas_academicas"
                                                value="{{ $titulacion->lineas_academicas }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="grado_academico"
                                                value="{{ $titulacion->grado_academico }}">
                                        </div>
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                ...
                                <a href="{{ route('estudiante.carta', [$titulacion->estudiante_id, $titulacion->programa_id]) }}"
